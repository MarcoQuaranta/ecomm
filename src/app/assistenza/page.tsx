              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{siteConfig.assistanceEmail}</p>
                    <p className="text-sm text-gray-500">Rispondiamo entro 48 ore</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Il nostro team risponde generalmente entro 48 ore lavorative.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm">
