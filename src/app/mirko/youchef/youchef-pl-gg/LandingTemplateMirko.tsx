                ...
                <div key={index} className={`review-card${index < reviewsShown ? ' visible' : ''}`}>
                  ...
                  {review.image && (
                    <div className="review-image">
                      <Image src={review.image} alt={`Foto di ${review.name}`} width={350} height={263} quality={75} style={{ maxWidth: '350px', width: '100%', height: 'auto', borderRadius: '8px', marginTop: '10px' }} />
                    </div>
                  )}
                  {review.sellerReply && (
