...
import { getFilteredProducts, type Product } from '@/lib/products';
...
export default function OffertePage() {
  ...
  const maxDiscount = Math.max(...allProducts.map(p => p.discount || 0));
      ...
      <div className="max-w-[1500px] mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="text-gray-600">
              <span className="font-semibold text-gray-900">{sortedProducts.length}</span> prodotti disponibili
            </div>
        ...
        {sortedProducts.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Nessun prodotto disponibile</h3>
            <p className="text-gray-600 mb-4">
              Al momento non ci sono prodotti
            </p>
            <Link
              href="/catalogo"
